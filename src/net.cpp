...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Dot " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"dottools.com", "dnsseed.dottools.com"},
    {"dotpool.org", "dnsseed.dotpool.org"},
    {"xurious.com", "dnsseed.dot.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"dottools.com", "testnet-seed.dottools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Dot is probably already running."), addrBind.ToString().c_str());
        else
